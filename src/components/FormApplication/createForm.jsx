...
const Form = () => {
  ...
  return (
    <div className="form">
      ...
      <CustomTextArea label="Адрес" placeholder="Введите адрес ПЗУ" text={text1} onTextChange={handleTextChange1} options={addresses} />
      <CustomTextArea label="Описание заявки" placeholder="Введите описание заявки" text={text3} onTextChange={handleTextChange3} maxLength={300}  />
      <CustomTextArea label="Тема заявки" placeholder="Введите тему заявки" text={text2} onTextChange={handleTextChange2} maxLength={50} />
